...
rm -f ../com.arm.wa.uiauto.calculator
if [[ -f app/build/apk/com.arm.wa.uiauto.calculator.apk ]]; then
    cp app/build/apk/com.arm.wa.uiauto.calculator.apk ../com.arm.wa.uiauto.calculator.apk
else
